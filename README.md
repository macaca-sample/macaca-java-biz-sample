...
公共库代码也已开源，详情参考：[github@Yinxl](https://github.com/Yinxl/macaca-java-biz) 或 [github@macaca-sample](https://github.com/macaca-sample/macaca-java-biz-framework)(目前两个库都在维护)
